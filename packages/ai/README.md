...
```bash
npm install @openeryc/pi-ai
```

TypeBox exports are re-exported from `@openeryc/pi-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@openeryc/pi-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@openeryc/pi-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@openeryc/pi-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@openeryc/pi-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@openeryc/pi-ai';
...
```typescript
import { getModel, stream } from '@openeryc/pi-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@openeryc/pi-ai';
...
```typescript
import { Model, stream } from '@openeryc/pi-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@openeryc/pi-ai';
...
```typescript
import { getModel, complete, Context } from '@openeryc/pi-ai';
...
```typescript
import { Context, getModel, complete } from '@openeryc/pi-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@openeryc/pi-ai/oauth` entry point in Node.js.
...
```typescript
import { getEnvApiKey } from '@openeryc/pi-ai';
...
```bash
npx @openeryc/pi-ai login              # interactive provider selection
npx @openeryc/pi-ai login anthropic    # login to specific provider
npx @openeryc/pi-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `@openeryc/pi-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
} from '@openeryc/pi-ai/oauth';
```

### Login Flow Example

```typescript
import { loginGitHubCopilot } from '@openeryc/pi-ai/oauth';
...
```typescript
import { getModel, complete } from '@openeryc/pi-ai';
import { getOAuthApiKey } from '@openeryc/pi-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@openeryc/pi-ai`
