...
import type { ExtensionAPI, ExtensionContext, Theme, ToolExecutionMode } from "@openeryc/pi-coding-agent";
import { type Component, matchesKey, Text, truncateToWidth, visibleWidth } from "@openeryc/pi-tui";
