...
import type { AssistantMessage, Model } from "@openeryc/pi-ai";
...
vi.mock("@openeryc/pi-ai", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@openeryc/pi-ai")>();
	return {
		...actual,
