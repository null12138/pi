...
For TypeScript definitions in your project, inspect `node_modules/@openeryc/pi-coding-agent/dist/`.
...
```typescript
import { convertToLlm, serializeConversation } from "@openeryc/pi-coding-agent";
