...
```typescript
import { AuthStorage, createAgentSession, ModelRegistry, SessionManager } from "@openeryc/pi-coding-agent";
...
```bash
npm install @openeryc/pi-coding-agent
```
...
```typescript
import { createAgentSession, SessionManager } from "@openeryc/pi-coding-agent";
...
The `Agent` class (from `@openeryc/pi-agent-core`) handles the core LLM interaction. Access it via `session.agent`.
...
```typescript
import { getModel } from "@openeryc/pi-ai";
import { AuthStorage, ModelRegistry } from "@openeryc/pi-coding-agent";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@openeryc/pi-coding-agent";
...
```typescript
import { createAgentSession } from "@openeryc/pi-coding-agent";
...
import { createAgentSession, defineTool } from "@openeryc/pi-coding-agent";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@openeryc/pi-coding-agent";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@openeryc/pi-coding-agent";
