...
| Package | Purpose |
|---------|---------|
| `@openeryc/pi-coding-agent` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
| `typebox` | Schema definitions for tool parameters |
| `@openeryc/pi-ai` | AI utilities (`StringEnum` for Google-compatible enums) |
| `@openeryc/pi-tui` | TUI components for custom rendering |
...
```typescript
import { isToolCallEventType } from "@openeryc/pi-coding-agent";
...
```typescript
import { isBashToolResult } from "@openeryc/pi-coding-agent";
...
```typescript
import { createLocalBashOperations } from "@openeryc/pi-coding-agent";
...
```typescript
import { SessionManager } from "@openeryc/pi-coding-agent";
...
```typescript
import type { AutocompleteItem } from "@openeryc/pi-tui";
...
```typescript
import { withFileMutationQueue } from "@openeryc/pi-coding-agent";
...
**Important:** Use `StringEnum` from `@openeryc/pi-ai` for string enums. `Type.Union`/`Type.Literal` doesn't work with Google's API.
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@openeryc/pi-coding-agent";
...
```typescript
import { createBashTool } from "@openeryc/pi-coding-agent";
...
```typescript
import { keyHint } from "@openeryc/pi-coding-agent";
...
```typescript
import { Text, Component } from "@openeryc/pi-tui";
...
import { matchesKey } from "@openeryc/pi-tui";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@openeryc/pi-coding-agent";
